		...
		<div class="content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<!-- Basic layout-->
					{!! Form::model($role, ['method' => 'PATCH', 'class' => 'form-horizontal', 'route' => ['roles.update', base64_encode($role['id'])]]) !!}
						<div class="panel panel-flat">
							...
							<div class="panel-body">
								<div class="form-group">
									...
									<div class="col-lg-9">
										<input type="text" class="form-control" placeholder="Masukkan Nama Role" name="i_nama" value="{!! $role['name'] !!}">
									</div>
								</div>
