...
@section('content')
	...
	<div class="content-wrapper">
		...
		<div class="content">
			...
			<!-- /basic tables title -->
			<a class="btn btn-primary content-group" href="{{ url('home/news/create') }}">Buat Berita Baru</a>
					...
					@foreach ($data as $index => $row)
						<tr>
							...
							<td class="text-center">
								<a href="{{ url('home/news') }}/{!! base64_encode($row['id']) !!}/edit" class="btn btn-primary btn-sm">Edit<i class="icon-pencil position-right"></i></a>
							</td>
							<td class="text-center">
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										<p>Apakah Anda Yakin Akan Menghapus <b>{!! $row['news_title'] !!}</b> ?</p>
									</div>

									<div class="modal-footer">
										{!! Form::open(array('method' => 'DELETE', 'route' => ['news.destroy', base64_encode($row['id'])])) !!}
