		...
		<div class="content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<!-- Basic layout-->
					{!! Form::model($service, ['method' => 'PATCH', 'class' => 'form-horizontal', 'route' => ['services.update', base64_encode($service['id'])], 'files' => true]) !!}
						<div class="panel panel-flat">
							<div class="panel-heading">
								<h5 class="panel-title">Edit Layanan</h5>
							...
							<div class="panel-body">
								<div class="form-group">
									...
									<div class="col-lg-9">
										<input type="text" class="form-control" placeholder="Masukkan Nama Layanan" name="i_nama" value="{!! $service['service_name'] !!}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-9">
										<img src="{{ asset($service['service_icon']) }}" class="img img-responsive">
									</div>
								</div>
