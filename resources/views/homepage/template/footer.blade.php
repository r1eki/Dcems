        ...
        <div class="row">
            ...
            <div class="info">
                <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                    <div class="heading">
                        <h3 class="heading-title">Dus Kemasan Cantik</h3>
                ...
                <div class="col-lg-4 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-12 col-xs-12">
                    <div class="services">
                        <div class="heading">
                            <h3 class="heading-title">Layanan Kami</h3>
                            <div class="heading-line">
                                <span class="short-line"></span>
                                <span class="long-line"></span>
                            </div>
            ...
            <div class="contacts">
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">0813 5768 8072</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <span>
                        Copyright © 2018 <a href="http://intivestudio.com" class="sub-footer__link">Intive Studio,</a>
                        Designed by <a href="http://intivestudio.com">Intive Studio</a>
                    </span>

                    <span>Developed by <a href="http://intivestudio.com">Intive Studio</a></span>
                    <span>Only on <a href="http://intivestudio.com">Intive Studio</a></span>
