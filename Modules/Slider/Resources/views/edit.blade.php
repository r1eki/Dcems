		...
		<div class="content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<!-- Basic layout-->
					{!! Form::model($slider, ['method' => 'PATCH', 'class' => 'form-horizontal', 'route' => ['slider.update', base64_decode($slider['id'])], 'files' => true]) !!}
						<div class="panel panel-flat">
							...
							<div class="panel-body">
								<div class="form-group">
									...
									<div class="col-lg-9">
										<input type="text" class="form-control" placeholder="Masukkan Judul Slider" name="i_nama" value="{!! $slider['slider_name'] !!}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-9">
										<img src="{{ asset($slider['slider_img']) }}" class="img img-responsive">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-9">
										<div class="checkbox checkbox-switchery">
											<label>
												<input type="checkbox" class="switchery" {!! ($slider['is_active'] == 'Y') ? 'checked' : '' !!} name="active">
											</label>
										</div>
									</div>
								</div>
