...
@section('content')
	...
	<div class="content-wrapper">
		...
		<div class="content">
			...
			<!-- /basic tables title -->
			<a class="btn btn-primary content-group" href="{{ url('home/category/create') }}">Buat Kategori Berita Baru</a>

			<!-- Basic datatable -->
			<div class="panel panel-flat">
				<div class="panel-heading">
					<h5 class="panel-title">List Kategori Berita</h5>
					...
					@foreach ($data as $index => $row)
						<tr>
							...
							<td class="text-center">
								<a href="{{ url('home/category') }}/{!! base64_encode($row['id']) !!}/edit" class="btn btn-primary btn-sm">Edit<i class="icon-pencil position-right"></i></a>
							</td>
							<td class="text-center">
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										<p>Apakah Anda Yakin Akan Menghapus <b>{!! $row['category_name'] !!}</b> ?</p>
									</div>

									<div class="modal-footer">
										{!! Form::open(array('method' => 'DELETE', 'route' => ['category.destroy', base64_encode($row['id'])])) !!}
