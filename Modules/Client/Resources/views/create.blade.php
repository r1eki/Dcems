		...
		<div class="content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<!-- Basic layout-->
					{!! Form::open(['method' => 'POST', 'class' => 'form-horizontal', 'route' => 'clients.store', 'files' => true]) !!}
						<div class="panel panel-flat">
							...
							<div class="panel-body">
								<div class="form-group">
									...
									<div class="col-lg-9">
										<input type="text" class="form-control" placeholder="Masukkan Nama Client" name="i_nama">
									</div>
								</div>
