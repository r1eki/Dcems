...
@section('content')
	...
	<div class="content-wrapper">
		...
		<div class="content">
			...
			<!-- /basic tables title -->
			<a class="btn btn-primary content-group" href="{{ url('home/clients/create') }}">Buat Client Baru</a>

			<!-- Basic datatable -->
			<div class="panel panel-flat">
				<div class="panel-heading">
					<h5 class="panel-title">List Client</h5>
				...
				<table class="table datatable-basic" id="basic">
					...
					@foreach ($data as $index => $row)
						<tr>
							...
							<td>
								<img src="{{ asset($row['client_logo']) }}" class="img img-responsive" style="width: 10%;">
							</td>
							<td class="text-center">
								<a href="{{ url('home/clients') }}/{!! base64_encode($row['id']) !!}/edit" class="btn btn-primary btn-sm">Edit<i class="icon-pencil position-right"></i></a>
							</td>
							<td class="text-center">
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-footer">
										{!! Form::open(array('method' => 'DELETE', 'route' => ['clients.destroy', base64_encode($row['id'])])) !!}
