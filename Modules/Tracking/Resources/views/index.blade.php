...
<!-- Main content -->
	<div class="content-wrapper">
		...
		<div class="page-header page-header-default">
			<div class="page-header-content">
				<div class="page-title">
					<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Tracking</h4>
				</div>
			</div>
		</div>
		<!-- /page header -->
		...
		<div class="content">
			...
			<!-- /basic tables title -->
			<a class="btn btn-primary content-group" href="{{ url('home/testimoni/create') }}">Buat Data Tracking</a>

			<!-- Basic datatable -->
			<div class="panel panel-flat">
				<div class="panel-heading">
					<h5 class="panel-title">Daftar Data Tracking</h5>
				...
				<table class="table datatable-basic" id="basic">
					...
					<tbody>
						...
						<td class="text-center">
								<a href="{{ url('home/tracking') }}/{!! base64_encode($row['tracking_id']) !!}/edit" class="btn btn-primary btn-sm">Edit<i class="icon-pencil position-right"></i></a>
							</td>
							<td class="text-center">
